...
Modify the intercepted request:
    ...
    username=carlos
➡️ The application now generates a password reset link using evil.com
...
The Host header should only be used for routing — not authentication.
...
- Mass exploitation of cached users
      ...
      ⚠️ Worse than reflected attacks because:
