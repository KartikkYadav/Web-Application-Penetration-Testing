...
Session ID is returned to the client in a cookie

Server retrieves session data on every request
...
Client stores the token (cookie or storage)
...
Security Considerations (Pentesting Perspective)
Cookies & Sessions
Test for:
